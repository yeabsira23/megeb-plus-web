...
const DEFAULT_REQUESTS: VerificationRequestDetail[] = [
  {
    ...
    documents: [
      {
        label: "State License",
        fileName: "state_license.pdf",
        fileType: "pdf",
        fileUrl: "",
        uploadedDate: "Aug 19, 2026",
      },
      {
        label: "National Credential (RDN/CNS)",
        fileName: "credential_cert.pdf",
        fileType: "pdf",
        fileUrl: "",
        uploadedDate: "Aug 19, 2026",
      },
      ...
      },
      {
        ...
        fileName: "degree_transcript.pdf",
        fileType: "pdf",
        fileUrl: "",
        uploadedDate: "Aug 19, 2026",
      },
  ...
  useEffect(() => {
    ...
    async function fetchRequests() {
      ...
      try {
        ...
        //
        // const data = await apiFetch<VerificationRequestDetail[]>(
...
function VerificationRequestsContent() {
  ...
  const filtered = requests.filter((request) => {
    ...
    const matchesQuery = request.name
      .toLowerCase()
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-[12px] text-[#2D312E]/50">
            Review nutritionist credentials and approve or
            reject applications.
          </p>
        </div>
                    ...
                    <div className="bg-[#FAF9F6]/60 px-5 py-4">
                      <div className="grid gap-3 text-[11.5px] sm:grid-cols-2">
                        <div>
                          ...
                          <p className="mt-0.5 text-[#2D312E]/50">
                            {request.email}
                          </p>
                        </div>
                          ...
                          {request.documents.map((doc) => (
                            ...
                            >
                              ...
                              <div className="min-w-0">
                                ...
                                <p className="truncate text-[9.5px] text-[#2D312E]/40">
                                  {doc.fileName}
                                </p>
                              </div>
                            </button>
