            ...
            <div className="p-9">
              ...
              >
                ...
                <div className="rounded-xl bg-[#E9F0EC] p-4">
                  <p className="font-body text-[12.5px] leading-5 text-[#2D312E]/60">
                    ...
                    <span className="font-semibold text-[#3D5A4C]">
                      123456
                    </span>{" "}
                ...
                <button
                  type="submit"
                  className="font-body w-full flex items-center justify-center rounded-xl bg-[#3D5A4C] text-white text-[14.5px] font-semibold py-3 transition hover:bg-[#4E876E] hover:shadow-[0_8px_20px_-4px_rgba(61,90,76,0.4)] active:scale-[0.99] focus:outline-none focus:ring-4 focus:ring-[#3D5A4C]/20"
                >
                  Verify Code
                </button>
              </form>
              ...
              <div className="mt-6 text-center">
                ...
                <button
                  ...
                  className="font-body mt-2 text-[12.5px] font-semibold text-[#4E876E] hover:text-[#3D5A4C] transition"
                >
                  Resend Code
                </button>
              </div>
